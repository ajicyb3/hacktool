...
elseif (strpos($ip, ' ') !== false)
  ...
  {
    echo "\n";
    userinput("Protokol (1)http (2)https [1/2]");
...
scanlist:
    ...
    echo $bold . $blue . "
      ...
      \n\n";
    echo $yellow . " [0]  Tugas simpel$white (Site Title, IP Address, CMS, Cloudflare Detection, Robots.txt Scanner)$yellow \n [1]  Whois Lookup \n [2]  Geo-IP Lookup \n [3]  Grab Banners \n [4]  DNS Lookup \n [5]  Subnet Calculator \n [6]  NMAP Port Scan \n [7]  Subdomain Scanner \n [8]  Revrse IP Lookup & CMS Detection \n [9]  SQLi Scanner$white (Mencari Kerentanan SQL.)$yellow \n [10] Bloggers View$white (Mencari informasi Blogger)(eng)$yellow \n [11] WordPress Scan$white (Hanya bekerja di CMS WordPress)(eng)$yellow \n [12] Admin Page Scanner \n [13] MX Lookup \n$magenta [A]  Full TUGAS - (Butuh waktu lama untuk selesai) (Bahasa eng) \n [B]  Ganti target (Kembali ke menu awal) \n$red [C]  keluar! \n\n" . $cln;
askscan:
        ...
        elseif ($scan == "9")
          {
            ...
            echo "\n$cln" . $lblue . $bold . "[+] Memulai tugas ... \n";
            echo $blue . $bold . "[i] Target:\e[92m $ipsl" . "$ip \n";
            echo $bold . $yellow . "[S] Tipe tugas : SQL Vulnerability Scanner" . $cln;
            echo "\n\n";
            $lulzurl = $reallink;
